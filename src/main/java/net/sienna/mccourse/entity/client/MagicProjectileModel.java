...
public class MagicProjectileModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MCCourseMod.MOD_ID, "magic_projectile"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int colour) {
		bb_main.render(poseStack, vertexConsumer, packedLight, packedOverlay, colour);
	}
}